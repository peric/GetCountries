...
var GeneratorActions = {
    generateOutput: function generateOutput(selectedOutputType, columns, settings, data) {
        var selectedColumns = [];
        var output = '',
            columnsDefinition = '',
            countries = '',
                ...
                if (settings.languagelookup.checked) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        for (var j = 0; j < selectedColumns.length; j++) {
                            ...
                            if (typeof value === "string") countries += "'" + value.replace(/\x27/g, '\\\x27') + "', ";else countries += value + ", ";
                        }
                        countries = countries.substring(0, countries.length - 2);
                        countries += "),";
                    }
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        for (var j = 0; j < columnsLookup.length; j++) {
                            ...
                            if (typeof value === "string") lookupCountries += "'" + value.replace(/\x27/g, '\\\x27') + "', ";else lookupCountries += value + ", ";
                        }
                        lookupCountries = lookupCountries.substring(0, lookupCountries.length - 2);
                        lookupCountries += "),";
                    }
                    ...
                    output = 'CREATE TABLE IF NOT EXISTS `countries` (\n' + '    `id` int(5) NOT NULL AUTO_INCREMENT,\n' + ('' + columnsDefinition) + '    PRIMARY KEY (`id`)\n' + ') ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=0;\n\n' + 'CREATE TABLE IF NOT EXISTS `country_lang_lnk` (\n' + ('' + lookupColumnsDefinition) + '    PRIMARY KEY (`countryCode`, `languages`)\n' + ') ENGINE=MyISAM DEFAULT CHARSET=utf8;\n\n' + (countries + '\n') + ('' + lookupCountries);
                } else {
                    countries = "INSERT INTO `countries` (";
                    for (var i = 0; i < selectedColumns.length; i++) {
                        columnName = selectedColumns[i].name;
                ...
                if (settings.languagelookup.checked) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        for (var j = 0; j < selectedColumns.length; j++) {
                            ...
                            if (columnName !== 'languages') {
                                if (typeof value === "string") country += "'" + value.replace(/\x27/g, '\\\x27') + "', ";else country += value + ", ";
                            }
                        }
...
},{"../variables/columnsLookup.js":9,"../variables/outputTypes.js":10}],2:[function(require,module,exports){
'use strict';
...
},{"zeroclipboard":18}],3:[function(require,module,exports){
'use strict';
...
React.render(React.createElement(GeneratorApp, { columns: columns, settings: settings, outputTypes: outputTypes }), document.getElementById('content'));

require('./actions/OutputActions.js');

},{"./actions/OutputActions.js":2,"./components/GeneratorApp.react":5,"./variables/columns.js":8,"./variables/outputTypes.js":10,"./variables/settings.js":11,"react":17}],4:[function(require,module,exports){
"use strict";
...
var GeneratorApp = React.createClass({
    ...
    toggleCheck: function toggleCheck(objectKey, type, selectedList) {
        var newState = {};
    ...
    getOutput: function getOutput(e) {
        ...
        $.getJSON(source).done((function (fetchedData) {
    ...
    render: function render() {
        ...
        var outputTypes = Object.keys(this.state.outputTypes).map(function (key, index) {
            ...
            return React.createElement(OutputType, {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'form',
                    { id: 'generateForm', onSubmit: this.getOutput },
                    React.createElement(
                        'div',
                        { className: 'text-center' },
                        React.createElement(
                            'button',
                            { id: 'generateButton', className: 'btn btn-primary btn-lg', type: 'submit', 'data-loading-text': 'Loading...' },
                            'Generate'
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            'button',
                            { id: 'copy-button', className: 'btn btn-default', 'data-clipboard-text': 'Copy Me!', title: 'Click to copy me.' },
                            'Copy to Clipboard'
                        )
                    )
                )
...
},{"../actions/GeneratorActions":1,"./Column.react":4,"./OutputType.react":6,"./Setting.react":7,"jquery":12,"react":17}],6:[function(require,module,exports){
"use strict";
...
var columnsLookup = [{ name: 'countryCode', mysql: 'char(2) NOT NULL DEFAULT \'\'', firebird: 'char(3) NOT NULL', checked: true }, { name: 'languages', mysql: 'varchar(100) DEFAULT NULL', firebird: 'varchar(100) DEFAULT NULL', checked: false }];
...
var OUTPUT_FIREBIRD = 'Firebird';
var OUTPUT_XML = 'XML';
var OUTPUT_JSON = 'JSON';
var OUTPUT_CSV = 'CSV';
var OUTPUT_YAML = 'YAML';
...
},{"./outputTypes.js":10}],12:[function(require,module,exports){
/*!
...
},{"_process":14,"object-assign":13}],16:[function(require,module,exports){
/** @license React v17.0.1
...
},{"object-assign":13}],17:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":15,"./cjs/react.production.min.js":16,"_process":14}],18:[function(require,module,exports){
/*!
 * ZeroClipboard
